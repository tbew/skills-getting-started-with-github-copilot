...
activities = {
    ...
    "Tennis Team": {
        "description": "Train and compete in varsity tennis matches",
    ...
    "Drama Club": {
        ...
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM; Saturdays, 10:00 AM - 12:00 PM",
        "max_participants": 25,
...
#This is code copied from training data
